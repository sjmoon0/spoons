...
//Necessary Data Structures:
	/*
		var player={
			socket:, 		//Use socket.id?
			currentRoom:,
			currentState:,
			turnNumber:, 	//Keeps gameplay in order
			interface:, 	//Mobile or desktop
		};
...
//Functions to create
	...
	/*
		createPlayer(socket, CurrentRoom, turnNumber, interface) //Creates a JSON player object. Adds to players array. Returns player
		deletePlayer(socketid?) //Removes player from players array
		createRoom()
		deleteRoom()
	*/
...
io.on('connection',function(socket){
	...
	socket.on('view room',function(roomInfo){
		...
		console.log("Someone is viewing the "+roomInfo+" room!");
		io.to(roomInfo).emit('room created',getRoomObject(roomInfo));
	});
